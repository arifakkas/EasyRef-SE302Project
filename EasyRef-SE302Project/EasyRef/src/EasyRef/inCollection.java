...
public class inCollection extends Reference {
    private SimpleStringProperty publisher, volume, series, address, edition, bookTitle, editor, chapter, pages, organization, note;



    public inCollection(String type, String key, String title, String author, String year, String month, String publisher, String volume, String series, String address, String edition, String pages, String bookTitle, String organization, String editor, String chapter, String note) {
